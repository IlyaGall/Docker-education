...
```
./dump_all.ps1 : Невозможно загрузить файл C:\gitHub\Docker-education\FinalProject\bd_load\dumps\dump_all.ps1, так как
выполнение сценариев отключено в этой системе. Для получения дополнительных сведений см. about_Execution_Policies по ад
ресу https:/go.microsoft.com/fwlink/?LinkID=135170.
строка:1 знак:1
+ ./dump_all.ps1
+ ~~~~~~~~~~~~~~
